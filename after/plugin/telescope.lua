...
vim.keymap.set("n", "<leader>ff", builtin.find_files, { desc = "Find all of the files" })
vim.keymap.set("n", "<C-p>ff", builtin.git_files, { desc = "Find all source controlled files. Not used often." })
vim.keymap.set("n", "<leader>fg", builtin.live_grep, { desc = "Ripgrep through file content" })
